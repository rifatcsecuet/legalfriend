            ...
            <div class="col-12">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active"><a href="{{ route('search.lawyer') }}"><img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner1.jpg')}}" alt="First slide"></a>  </div>
                        <div class="carousel-item"><a href="https://amardoctor.com.bd/public/index.php/contact/service/nursing"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner2.jpg')}}" alt="Second slide"></a> </div>  
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner3.jpg')}}" alt="Third slide"> </a></div>
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner4.jpg')}}" alt="Fourth slide"> </a></div>
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner5.jpeg')}}" alt="Fifth slide"> </a></div>
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner6.jpg')}}" alt="Sixth slide"> </a></div>
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner7.jpg')}}" alt="Seventh slide"> </a></div>
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner8.jpg')}}" alt="Eighth slide"> </a></div>
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner9.jpg')}}" alt="Ninth slide"> </a></div>
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner10.jpg')}}" alt="Tenth slide"> </a></div>
                        <div class="carousel-item"><a href="{{ route('search.lawyer') }}"> <img class="d-block w-100" src="{{asset('public/frontend/assets/img/banner11.jpg')}}" alt="Eveventh slide"> </a></div>                                                
                    </div>
...
<section class="services1">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-12">
                <a href="{{ route('search.lawyer') }}"> <img class="img-fluid" src="{{asset('/')}}frontend/assets/img/lawyer.jpg"> </a>
                <br>
                <br>
                <span>Ideal for male aged 21 to 40 years</span> </div>
