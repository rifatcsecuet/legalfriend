				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-5 col-lg-4 col-xl-3 theiaStickySidebar">
							...
							<!-- Profile Sidebar -->
                            @include('backend.multi-dashboard.lawyer._sidebar_lawyer')
							<!-- /Profile Sidebar -->
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							...
							<div class="card">
                              ...
                              @if($data->profile_image == "default.png")														    
															<img src="{{ asset('public/default/default.png') }}" alt="User Image">
                          ...
                          <form action="{{ route('lawyer.update.profile_pic') }}" method="post" enctype="multipart/form-data">
                              @csrf
                            ...
                            <!-- About Me -->
                            <div class="content">
                            <form action="{{ route('lawyer.upadeteprofileSeetings') }}" method="POST">
                            @csrf
							...
							<div class="card services-card">
								<div class="card-body">
                                    ...
                                    <br><div class="col-md-6">
										...
										<input class="input-tags form-control" type="text" data-role="tagsinput" placeholder="Enter Your Fees" name="lawyer_fees" value="{{$details->lawyer_fees}}"  id="lawyer_fees">
                                    </div>
                                    <br>
                                    <div class="col-md-6">
                                        <div class="form-group">
