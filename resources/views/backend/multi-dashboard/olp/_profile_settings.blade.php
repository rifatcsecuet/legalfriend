...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="change-avatar">
                                        ...
                                        <div class="upload-img">
                                            <form action="{{ route('olp.olpPicUpdate') }}" method="post" enctype="multipart/form-data">
                                                @csrf
            ...
            <!-- About Me -->
                <div class="content">
                    <form action="{{route('olp.profileAllUpdate')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
